  ...
  return <div className="min-h-screen bg-[#F9F7F0] flex flex-col">
      <header className="bg-white/80 backdrop-blur-sm border-b border-[#9C7705]/10">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div>
            {isAuthenticated ? <Button onClick={() => navigate("/dashboard")} className="bg-[#3B751E] hover:bg-[#3B751E]/90">
                Go to Dashboard
              </Button> : <Button onClick={() => navigate("/login")} className="bg-[#3B751E] hover:bg-[#3B751E]/90">
                Sign In
              </Button>}
          </div>
        </div>
      ...
      <main className="flex-1">
        <section className="bg-[#3B751E] text-white py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold mb-6">TotalHomeGrown - Affiliate Management Portal</h1>
            <p className="text-xl max-w-2xl mx-auto mb-8">
              Track your affiliate earnings, view usage statistics, and manage your account in one place.
            </p>
            {isAuthenticated ? <Button onClick={() => navigate("/dashboard")} size="lg" className="bg-white text-[#3B751E] hover:bg-white/90">
                Go to Dashboard
                <ChevronRight className="ml-2 h-4 w-4" />
              </Button> : <Button onClick={() => navigate("/login")} size="lg" className="bg-white text-[#3B751E] hover:bg-white/90">
                Sign In
                <ChevronRight className="ml-2 h-4 w-4" />
              </Button>}
          </div>
        ...
        {!isAuthenticated && <section className="py-16 bg-white">
            <div className="container mx-auto px-4 max-w-4xl text-center">
              ...
              <div className="bg-[#F9F7F0] p-8 rounded-lg shadow-sm border border-[#9C7705]/10 mb-8">
                ...
                <Button onClick={() => window.open("https://docs.google.com/forms/d/e/1FAIpQLSfqUn0QmIJhc1wf5u24k9zXoy9ingwqC5JD6OhvzfRbprbXHg/viewform?usp=sharing", "_blank")} size="lg" className="bg-[#3B751E] hover:bg-[#3B751E]/90 text-white">
                  Apply to Join
              ...
              <div className="flex items-center justify-center space-x-4">
                ...
                <Button variant="outline" onClick={() => navigate("/login")} className="border-[#3B751E] text-[#3B751E] hover:bg-[#3B751E]/10">
        ...
        {isAdmin && <section className="py-12 bg-[#3B751E]/10">
            <div className="container mx-auto px-4 text-center">
              ...
              <Button onClick={() => navigate("/admin")} className="bg-[#3B751E] hover:bg-[#3B751E]/90">
