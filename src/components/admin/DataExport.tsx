...
import { CalendarIcon, BarChart4, FileDown, FileSpreadsheet, ShieldAlert } from "lucide-react";
...
function DatePicker({ date, setDate, className }: { date: Date | undefined, setDate: (date: Date | undefined) => void, className?: string }) {
  return (
    <Popover>
